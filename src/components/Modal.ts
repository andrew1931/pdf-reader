...
export const Modal = (() => {
   ...
   backdrop.classList.add('absolute', 'w-full', 'h-full');
   ...
   closIcon.classList.add('btn-icon', 'w-7', 'h-7', 'cursor-pointer', 'absolute', 'right-0', 'p-1');
   ...
   body.classList.add('w-full', 'flex', 'flex-col', 'mt-1', 'flex-1');
